---
title: "5.2_PLSC_grad_GSR_combat_(SSD) symptoms only"
author: "Ju-Chi.Yu"
date: "11/16/2022"
...
lol_spins_behav_smp <- cbind(lol_spins_behav,
  lol_original[lol_spins_behav$subject, c(22:27,31:39)],
  behav_sans[lol_spins_behav$subject, c(2:5)])
...
cog.dat <- lol_spins_behav_ssd[kept.sub,c(6:19)]
behav.dat <- lol_spins_behav_ssd[kept.sub,c(22:40)]
...
## Correlation to cognitive behaviors

```{r}
## select lx/ly
ssd.lx <- pls.res$TExPosition.Data$lx
ssd.ly <- pls.res$TExPosition.Data$ly

## overall corplot
corrplot::corrplot(cor(cbind(cog.dat, ssd.lx, ssd.ly)), method = "shade")
...
cor.mat <- psych::corr.test(cog.dat, lxly.12, adjust = "fdr")
