...
spins_behav_num <- lol_spins_behav %>% 
  select(scog_rmet_total, scog_er40_total, scog_mean_ea, scog_tasit1_total,
         ...
         np_domain_tscore_reasoning_ps, bsfs_sec2_total, bsfs_sec3_total,
         bsfs_sec3_total, bsfs_sec4_total, bsfs_sec5_total, bsfs_sec6_total,
         fd_mean_rest
  ) %>% data.frame
...
var2regout <- lol_spins_behav %>%
  select(demo_sex, demo_age_study_entry, `fd_mean_rest`) %>% data.frame
...
behav.dat <- spins_behav_num[kept.sub,c(1:20)]
