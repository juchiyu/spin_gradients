...
kept.sub <- lol_spins_behav$record_id[complete.cases(lol_spins_behav)==TRUE] # 417; 3 people has missing fd_mean
...
gradient_raw_brain <- pq_for_plot %>%
  ...
  scale_fill_distiller(palette = "BrBG", limits = c(-1.5,1.5), values = c(0, 0.4, 0.5, 0.6, 1)) +
  ggtitle("Gradients")
```
