...
pls.boot <- data4PCCAR::Boot4PLSC(behav.reg, grad.reg, scale1 = TRUE, scale2 = TRUE, nIter = 1000, nf2keep = 5)

pls.inf <- data4PCCAR::perm4PLSC(behav.reg, grad.reg, scale1 = TRUE, scale2 = TRUE, nIter = 1000)
