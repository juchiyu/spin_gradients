...
lxly.12 <- cbind(ssd.lx[,1:2], ssd.ly[,1:2])
colnames(lxly.12) <- c("lx.1", "lx.2", "ly.1", "ly.2")

cor.mat <- psych::corr.test(spins_symp_ssd, lxly.12)

## plot
corrplot::corrplot(t(cor.mat$r), method = "shade", addCoef.col = TRUE, addCoefasPercent = TRUE, number.font = 0.2, p.mat = t(cor.mat$p), insig = "pch")
